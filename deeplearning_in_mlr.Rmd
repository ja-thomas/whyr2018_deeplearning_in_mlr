...
<img src="images/magic.png" width="650px"/>
...
* Currently implemented DL framework is Apache __Apache MXNet__
* Not included in __mlr__ (yet) but can be directly called from the __mlr-extralearner__ repository
...
It is also possible to create the architecture directly and pass the __symbol__ to __mlr__
...
With this we can run some more complex state of the art CNNs in __mlr__.
At [](https://github.com/apache/incubator-mxnet/tree/master/example) a large number of architectures are already defined.
We can directly source them from there.
...
- Early stopping can be passed to the __epoch.end.callback__ parameter
...
- We can use the __mlr__ for tuning networks easily
